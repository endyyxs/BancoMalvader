...
public class ExtratoClienteView extends JFrame {
	private JPasswordField senha;

    public ExtratoClienteView() {
    	super("Extrato"); 
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ExtratoClienteView().setVisible(true);
            }
        });
    }
}
