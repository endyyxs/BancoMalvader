    ...
    public MenuClienteView() {
        ...
        saldo.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                SaldoClienteView telasaldo = new SaldoClienteView();
        ...
        deposito.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                DepositoClienteView teladeposito = new DepositoClienteView();
        ...
        extrato.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                ExtratoClienteView telaextrato = new ExtratoClienteView();
        ...
        saque.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                SaqueClienteView telasaque = new SaqueClienteView();
        ...
        consultarlimite.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                ConsultarLimiteClienteView telaconsultarlimite = new ConsultarLimiteClienteView();
                telaconsultarlimite.setVisible(true);
                dispose();
            } 
        }); 
